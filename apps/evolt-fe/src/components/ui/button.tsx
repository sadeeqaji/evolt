...
// Define a simple, reusable loader icon with a spinning animation
...
// Define the component's props interface for better type-safety and clarity
  ...
  (
    {
      ...
      size,
      asChild = false,
      loading = false, // Destructure the new loading prop
      children,
      ...props
    },
    ref
