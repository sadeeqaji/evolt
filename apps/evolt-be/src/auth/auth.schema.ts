...
export const InvestorNonceSchema: FastifySchema = {
  description:
    'Generate a unique nonce for investor Hedera account verification',
  tags: ['auth'],
  querystring: {
    type: 'object',
    required: ['accountId'],
        ...
        data: {
          ...
          properties: {
            nonce: {
              type: 'string',
              description:
                'Randomly generated challenge (nonce) to be signed by the wallet',
            },
          },
        },
      },
...
export const InvestorVerifySignatureSchema: FastifySchema = {
  description:
    'Verify Hedera wallet signature and issue JWT for authenticated sessions',
  tags: ['auth'],
  body: {
    type: 'object',
...
export const AdminLogoutSchema: FastifySchema = {
